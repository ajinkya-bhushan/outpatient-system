...
from app.diarization.config import ClusteringConfig
...
def cluster_embeddings(
    ...
    if n < config.min_subsegs_for_spectral:
        ...
        return ClusteringResult(labels, int(len(set(labels))), "agglomerative", None, cohesion)
    ...
    result = ClusteringResult(
        labels=labels,
        num_speakers=int(len(set(labels.tolist()))),
        method="spectral",
        pval=pval,
