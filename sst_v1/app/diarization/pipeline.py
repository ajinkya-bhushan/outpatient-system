...
:mod:`app.diarization.alignment` joins the result to a Whisper transcript.
...
from app.diarization.clustering import cluster_embeddings
from app.diarization.config import DiarizationConfig
from app.diarization.embeddings import ECAPAEmbedder, build_subsegments
from app.diarization.vad import SpeechBrainVAD
